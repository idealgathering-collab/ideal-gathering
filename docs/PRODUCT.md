...
- The Life Profile is the existing Profile. IG-003 adds the [Life Moments foundation](LIFE_MOMENTS.md); IG-004 adds an optional Remember this? flow on completed gathering detail using known facts and private-by-default personal context. No separate /life product, timeline or automatic creation is shipped by either task.
