// Full ISO 3166-1 alpha-2 country list, used for the nationality dropdown.
// Distinct from COUNTRIES in locations.ts, which is the narrower residence/market list.
...
export function nationalityName(code: string | null | undefined): string | null {
  if (!code) return null;
